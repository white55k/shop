<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"C:\wamp64\www\my_obj\shop\public/../app/index\view\index.html";i:1508739313;}*/ ?>
			...
			<div class="am-container header">
				...
				<ul class="message-r">
					<div class="topMessage home">
						<div class="menu-hd"><a href="<?php echo url(); ?>" target="_top" class="h">商城首页</a></div>
					</div>
										...
										<?php foreach($res_menu as $v): ?>
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<?php echo $v['icon']; ?>"></i><a class="ml-22" title="点心"><?php echo $v['name']; ?></a></h3>
													<em>&gt;</em></div>
															...
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort">
																		...
																		<dd><a title="蒸蛋糕" href="#"><span><?php echo $val['name']; ?></span></a></dd>
																		<?php endforeach; ?>
																	</dl>
																</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						...
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="<?php echo url('Introduct/good', ['gid'=>$v['gid']]); ?>"><img src="<?php echo $v->picture[0]->path_url; ?>"></img></a>
							</div>
						</div>	
						<?php endforeach; ?>					
					</div>
							...
							<div class="am-u-sm-3 ">
							  <div class="icon-sale two "></div>	
								...
								<div class="activityMain ">
									<a href="<?php echo url('Introduct/seckill', ['sid'=>$v['sid']]); ?>"><img src="<?php echo $v->picture[0]->path_url; ?>"></img></a>
								</div>
								<div class="info ">
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
							<?php $__FOR_START_10058__=0;$__FOR_END_10058__=6;for($i=$__FOR_START_10058__;$i < $__FOR_END_10058__;$i+=1){ ?>
								<a class="outer" href="#"><span class="inner"><b class="text"><?php echo $v->sort[$i]['name']; ?></b></span></a>
							<?php } ?>									
							</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two sug">
								<div class="outer-con ">
									...
									<a href=""><i class="am-icon-shopping-basket am-icon-md  seprate"></i></a>
								</div>
								<a href="<?php echo url('Introduct/good', ['gid'=>$v->sort[0]->good[0]['gid']]); ?>"><img src="<?php echo $v->sort[0]->good[0]->picture[0]['path_url']; ?>" /></a>
							</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="<?php echo url('Introduct/good', ['gid'=>$v->sort[0]->good[1]['gid']]); ?>"><img src="<?php echo $v->sort[0]->good[1]->picture[0]['path_url']; ?>" /></a>
							</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three big">
							...
							<a href="<?php echo url('Introduct/good', ['gid'=>$v->sort[0]->good[2]['gid']]); ?>"><img src="<?php echo $v->sort[0]->good[2]->picture[0]['path_url']; ?>" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three sug">
							...
							<a href="<?php echo url('Introduct/good', ['gid'=>$v->sort[0]->good[3]['gid']]); ?>"><img src="<?php echo $v->sort[0]->good[3]->picture[0]['path_url']; ?>" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="<?php echo url('Introduct/good', ['gid'=>$v->sort[0]->good[4]['gid']]); ?>"><img src="<?php echo $v->sort[0]->good[4]->picture[0]['path_url']; ?>" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three last big ">
							...
							<a href="<?php echo url('Introduct/good', ['gid'=>$v->sort[0]->good[5]['gid']]); ?>"><img src="<?php echo $v->sort[0]->good[5]->picture[0]['path_url']; ?>" /></a>
						</div>
