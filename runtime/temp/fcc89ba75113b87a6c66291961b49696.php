...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link type="text/css" href="__CSS__/optstyle.css" rel="stylesheet" />
		<link type="text/css" href="__CSS__/style.css" rel="stylesheet" />

		<script type="text/javascript" src="__BASIC_JS__/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="__BASIC_JS__/quick_links.js"></script>

		<script type="text/javascript" src="__AMAZEUI_JS__/amazeui.js"></script>
		<script type="text/javascript" src="__JS__/jquery.imagezoom.min.js"></script>
		<script type="text/javascript" src="__JS__/jquery.flexslider.js"></script>
		<script type="text/javascript" src="__JS__/list.js"></script>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="__IMAGES__/01.jpg" title="pic" />
								</li>
								<li>
									<img src="__IMAGES__/02.jpg" />
								</li>
								<li>
									<img src="__IMAGES__/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
												...
												$(".hot span").click(function() {
													...
													$.post('<?php echo url("Coupon/addUser"); ?>',{gid:1},function(data){
														if (!data) {
															...
															$('.gold-list li').html(data.descrbe);
														}
													});
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="__IMAGES__/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
