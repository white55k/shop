<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wei2017\wamp64\www\shop\public/../app/index\view\information.html";i:1508764836;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<script src="__AMAZEUI_JS__/jquery.min.js" type="text/javascript"></script>
		<script src="__AMAZEUI_JS__/amazeui.js" type="text/javascript"></script>
					...
					<div class="user-info">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								...
								<img class="am-circle am-img-thumbnail" src="__IMAGES__/<?php echo $pic; ?>" alt="" />
							</div>

							<p class="am-form-help">头像</p>

							<div class="info-m">
								<div><b>用户名：<i><?php echo $username; ?></i></b></div>
								<div class="u-level">
									<span class="rank r2">
							             <s class="vip1"></s><a class="classes" href="#"><?php echo $gold; ?></a>
						            </span>
								</div>
								<div class="u-safety">
									<a href="safety.html">
							...
							<form class="am-form am-form-horizontal">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" placeholder="<?php echo $username; ?>">
